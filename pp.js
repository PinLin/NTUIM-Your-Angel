function fireflies() {
    ...
    function getCanvas() { return document.getElementById('pixie'); }
    ...
    function Circle() {
        ...
        this.draw = function () {
            ...
            this.con.closePath();
            var cr = this.r * newo;
            g = this.con.createRadialGradient(this.x, this.y, 0, this.x, this.y, (cr <= 0 ? 1 : cr));
